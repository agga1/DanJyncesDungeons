...
shop_icon = pygame.image.load("../resources/images_and_animations/shop/shop_icon.png")
shop_bar = pygame.image.load("../resources/images_and_animations/shop/shop_bar.png")
